...
In addition to the individual folders, the repository contains a file named **`Summary of All Folders.txt`**. This file compiles the percentage contributions of the intermolecular contacts from every analyzed structure, providing a convenient overview of the complete dataset without the need to inspect each folder individually.
